    ...
    <details className="rules-disclosure">
      ...
      <section className="panel rules-panel">
        <div className="panel__header">
          <p className="panel__eyebrow">Rules Snapshot</p>
          <h2>How Chessxox works</h2>
        </div>
        ...
        <ul className="rules-list">
          ...
          <li>If any capture is available, you must capture. Drops and pushes are not allowed that turn.</li>
